...
const { fetchTableData, updateRowData, selectUser, logInChecks } = require('./scripts/queries');
...
ipcMain.handle('log-in-user', (event, userDetails) => {
    return logInChecks(userDetails);
});
